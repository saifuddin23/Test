define({
  ...
  "useCurrentExtentTip": "現在のマップ範囲に含まれるフィーチャのみを返します",
  "useDrawGraphicTip": "マップに描画された図形と交差するフィーチャのみを返します",
  "useFeaturesTip": "別のレイヤー内のフィーチャとの空間リレーションシップのあるフィーチャのみを返します",
  "noSpatialLimitTip": "マップの全範囲に含まれるフィーチャを返します",
