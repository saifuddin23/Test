...
define([
  ...
  function(on, query, declare, array, BaseWidgetSetting, _WidgetsInTemplateMixin, html, lang, FeatureLayer,
    ...
    Popup, jimuUtils, DataSourceManager, LayerInfos, utils, igUtils, store, CheckBox) {
    ...
    return declare([BaseWidgetSetting, _WidgetsInTemplateMixin], {
      ...
      _setDataSource: function(dataSource) {
        if(!igUtils.checkDSIsVaild(dataSource, this.map, this.appConfig)){
          this._handleNoDataSource();
          return;
        }
        if (!this._dataSource) {
